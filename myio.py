...
TRAIN_TEST_DATASET_CONFIG_FILE_TYPE=1 #unused
...
SPATIAL_RESOLUTION_KEY="spatial resolution (m)"
INPUT_TILE_SIZE_KEY="input tile size (k x k)"#1 for basic ML (one sample), and DNN, and > 1 for LSTM and CNN that have time dimension in input ( INPUT_TILE_SIZE_KEY x INPUT_TILE_SIZE_KEY input features per target variable)
RNG_SEED_KEY="seed"
...
NUMBER_OF_RANDOM_SAMPLES_PER_CLIENT_KEY= "number of random samples to take per client" #<= 0 means no sampling, > 0 means random samplign applied
...
FEDERATED_LEARNING_HYPERPARAMETER_SET_KEY="hyperparameter set"
...
configCommonFieldTypeMap[NUMBER_OF_RANDOM_SAMPLES_PER_CLIENT_KEY]=np.int64
...
configCommonFieldTypeMap[SPATIAL_RESOLUTION_KEY]=np.float64
configCommonFieldTypeMap[INPUT_TILE_SIZE_KEY]=np.int64
...
configFieldTypeMaps[FEDERATED_LEARNING_CONFIG_FILE_TYPE][SPATIAL_RESOLUTION_KEY]=np.float64
configFieldTypeMaps[FEDERATED_LEARNING_CONFIG_FILE_TYPE][ALGORITHM_KEY]=str
configFieldTypeMaps[FEDERATED_LEARNING_CONFIG_FILE_TYPE][INPUT_TILE_SIZE_KEY]=np.float64
...
configFieldTypeMaps[FEDERATED_LEARNING_CONFIG_FILE_TYPE][NUMBER_OF_RANDOM_SAMPLES_PER_CLIENT_KEY]=np.int64
...
# example:
#>/home/user/yield/2024-ml/2024-03-11_12_37_42/
#											> log
#											>results.csv
#											>experiments/
#												>e0/
